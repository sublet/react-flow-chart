...
exports.onDragNode = function (_a) {
    ...
    return function (chart) {
        ...
        if (nodechart) {
            ...
            chart.nodes[id] = __assign({}, nodechart, { position: position });
        }
        return chart;
    };
};
exports.onDragStop = function (_a) {
    var config = _a.config, event = _a.event, data = _a.data, id = _a.id;
    return function (chart) {
        return chart;
    };
};
exports.onCanvasKeyCommand = function (_a) {
    var config = _a.config, keyCode = _a.keyCode;
    return function (chart) {
        return chart;
    };
};
...
exports.onPortEnter = function (_a) {
    var config = _a.config, port = _a.port, node = _a.node;
    return function (chart) {
